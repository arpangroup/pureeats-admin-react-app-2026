import type { Restaurant, RestaurantCategory, RestaurantCategorySlider, RestaurantUser } from '@/types/entities'
...
export const restaurantCategorySliders: RestaurantCategorySlider[] = [
  { id: 1, name: 'Top Cuisines', image: '', imagePlaceholder: '', categoriesIds: [1, 2, 3], isActive: true, createdAt: '2025-10-02T09:00:00Z', updatedAt: '2025-10-02T09:00:00Z' },
  { id: 2, name: 'Weekend Picks', image: '', imagePlaceholder: '', categoriesIds: [4, 5, 6], isActive: true, createdAt: '2025-10-03T09:00:00Z', updatedAt: '2025-10-03T09:00:00Z' },
]

export const restaurants: Restaurant[] = [
  {
    id: 1, name: 'Spice Garden', slug: 'spice-garden', description: 'Authentic North Indian curries and tandoor specials.',
    contactNumber: '9811100001', openingTime: '10:00', closingTime: '23:00', locationId: 1,
    image: '', placeholderImage: '', rating: 4.5, deliveryTime: 32, priceRange: 2, isPureveg: false,
    address: '12, 5th Block, Koramangala', pincode: '560095', landmark: 'Near Forum Mall', sku: 'RES-0001',
    latitude: 12.9346, longitude: 77.6104, certificate: null, restaurantCharges: 20, deliveryCharges: 25,
    isActive: true, isAccepted: true, isFeatured: true, commissionRate: 18, deliveryType: 'platform-rider',
    deliveryRadius: 8, deliveryChargeType: 'distance-based', baseDeliveryCharge: 20, baseDeliveryDistance: 2,
    extraDeliveryCharge: 5, extraDeliveryDistance: 1, minOrderPrice: 99, isNotifiable: true, autoAcceptable: false,
    isSchedulable: true, isAcceptCod: true, categoryIds: [1, 5],
  ...
  },
  {
    ...
    contactNumber: '9811100002', openingTime: '07:00', closingTime: '22:00', locationId: 5,
    image: '', placeholderImage: '', rating: 4.7, deliveryTime: 25, priceRange: 1, isPureveg: true,
    address: '45, 4th Main, Jayanagar', pincode: '560011', landmark: 'Opp. Jayanagar Bus Stand', sku: 'RES-0002',
    latitude: 12.9308, longitude: 77.5838, certificate: null, restaurantCharges: 10, deliveryCharges: 20,
    isActive: true, isAccepted: true, isFeatured: true, commissionRate: 15, deliveryType: 'own-rider',
    ...
    isSchedulable: false, isAcceptCod: true, categoryIds: [2],
  ...
  },
  {
    ...
    contactNumber: '9811100003', openingTime: '11:00', closingTime: '23:30', locationId: 2,
    image: '', placeholderImage: '', rating: 4.3, deliveryTime: 35, priceRange: 2, isPureveg: false,
    ...
    deliveryRadius: 10, deliveryChargeType: 'distance-based', baseDeliveryCharge: 25, baseDeliveryDistance: 2,
    extraDeliveryCharge: 6, extraDeliveryDistance: 1, minOrderPrice: 149, isNotifiable: false, autoAcceptable: false,
    isSchedulable: true, isAcceptCod: false, categoryIds: [3],
  ...
  },
  {
    ...
    contactNumber: '9811100004', openingTime: '08:00', closingTime: '21:00', locationId: 3,
    image: '', placeholderImage: '', rating: 4.6, deliveryTime: 28, priceRange: 2, isPureveg: true,
    address: '27th Main, HSR Layout', pincode: '560102', landmark: 'Near Agara Lake', sku: 'RES-0004',
    latitude: 12.9151, longitude: 77.6386, certificate: null, restaurantCharges: 15, deliveryCharges: 22,
    isActive: true, isAccepted: true, isFeatured: true, commissionRate: 16, deliveryType: 'platform-rider',
    deliveryRadius: 7, deliveryChargeType: 'distance-based', baseDeliveryCharge: 22, baseDeliveryDistance: 2,
    extraDeliveryCharge: 4, extraDeliveryDistance: 1, minOrderPrice: 99, isNotifiable: true, autoAcceptable: true,
    isSchedulable: false, isAcceptCod: true, categoryIds: [4],
  ...
  },
  {
    ...
    contactNumber: '9811100005', openingTime: '12:00', closingTime: '00:00', locationId: 4,
    image: '', placeholderImage: '', rating: 4.1, deliveryTime: 40, priceRange: 3, isPureveg: false,
    ...
    isActive: false, isAccepted: true, isFeatured: false, commissionRate: 18, deliveryType: 'own-rider',
    ...
    isSchedulable: true, isAcceptCod: true, categoryIds: [5],
  ...
  },
  {
    ...
    contactNumber: '9811100006', openingTime: '11:30', closingTime: '23:00', locationId: 6,
    image: '', placeholderImage: '', rating: 4.0, deliveryTime: 38, priceRange: 2, isPureveg: false,
    ...
    isActive: true, isAccepted: false, isFeatured: false, commissionRate: 15, deliveryType: 'platform-rider',
    deliveryRadius: 8, deliveryChargeType: 'distance-based', baseDeliveryCharge: 25, baseDeliveryDistance: 2,
    extraDeliveryCharge: 5, extraDeliveryDistance: 1, minOrderPrice: 129, isNotifiable: true, autoAcceptable: false,
    isSchedulable: false, isAcceptCod: true, categoryIds: [6],
