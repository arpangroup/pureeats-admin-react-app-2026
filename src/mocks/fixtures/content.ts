...
export const modules: Module[] = [
  ...
  { id: 2, name: 'Referral Module', shortName: 'referral', code: 'referralmodule', description: 'Encourage user referrals with reward systems', version: '1.0.0', isActive: false, isInstalled: false, settingsPath: '/admin/modules/referral/settings', updateDate: '2026-06-01', createdAt: '2025-10-01T09:00:00Z', updatedAt: '2026-06-01T09:00:00Z' },
  { id: 3, name: 'MLM Module', shortName: 'mlm', code: 'mlmmodule', description: 'Encourage user referrals with reward systems', version: '1.0.0', isActive: true, isInstalled: false, settingsPath: '/admin/modules/mlm/settings', updateDate: '2026-06-01', createdAt: '2025-10-01T09:00:00Z', updatedAt: '2026-06-01T09:00:00Z' },
  { id: 4, name: 'Loyalty Points', shortName: 'loyalty', code: 'loyaltymodule', description: 'Reward repeat customers with points', version: '1.0.2', isActive: false, isInstalled: true, settingsPath: '/admin/modules/loyalty/settings', updateDate: '2026-03-11', createdAt: '2025-12-01T09:00:00Z', updatedAt: '2026-03-11T09:00:00Z' },
  { id: 5, name: 'Live Chat Support', shortName: 'livechat', code: 'livechatmodule', description: 'In-app chat between customers and support', version: '0.9.0', isActive: false, isInstalled: false, settingsPath: null, updateDate: null, createdAt: '2026-02-01T09:00:00Z', updatedAt: '2026-02-01T09:00:00Z' },
  { id: 6, name: 'Delivery Area Pro Module', shortName: 'deliveryarea', code: 'deliveryareamodule', description: 'Advanced zone and boundary configuration for deliveries', version: '1.2.0', isActive: false, isInstalled: false, settingsPath: null, updateDate: null, createdAt: '2026-02-01T09:00:00Z', updatedAt: '2026-02-01T09:00:00Z' },
  { id: 7, name: 'SuperCache Module', shortName: 'supercache', code: 'supercachemodule', description: 'Performance optimization for faster load times', version: '1.0.0', isActive: false, isInstalled: false, settingsPath: null, updateDate: null, createdAt: '2026-02-01T09:00:00Z', updatedAt: '2026-02-01T09:00:00Z' },
  { id: 8, name: 'Thermal Printer Module', shortName: 'thermalprinting', code: 'thermalprintingmodule', description: 'Automates receipt and order printing for kitchens', version: '1.0.0', isActive: false, isInstalled: false, settingsPath: null, updateDate: null, createdAt: '2026-02-01T09:00:00Z', updatedAt: '2026-02-01T09:00:00Z' },
  { id: 9, name: 'Call And Order Module', shortName: 'callandorder', code: 'callandordermodule', description: 'Allows customers to place orders via phone call integration', version: '1.0.0', isActive: false, isInstalled: false, settingsPath: null, updateDate: null, createdAt: '2026-02-01T09:00:00Z', updatedAt: '2026-02-01T09:00:00Z' },
  { id: 10, name: 'Order Schedule Module', shortName: 'orderschedule', code: 'orderschedulemodule', description: 'Enables advance ordering and time-slot scheduling', version: '1.0.0', isActive: false, isInstalled: false, settingsPath: null, updateDate: null, createdAt: '2026-02-01T09:00:00Z', updatedAt: '2026-02-01T09:00:00Z' },
]
