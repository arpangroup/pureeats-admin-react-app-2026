...
export function Modal({ open, onClose, title, children, footer, size = 'md' }: ModalProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-slate-900/40 p-4 pt-12 backdrop-blur-sm dark:bg-slate-950/60">
      <div className={classNames('w-full rounded-xl bg-white shadow-xl dark:bg-slate-900', sizeClasses[size])}>
